...
//
// PURPOSE:  Ship an item to a customer using the /ship endpoint. 
//
// The /ship endpoint is used to ship a single item.
// 
// API Parameters:
//     address:  The physical address or blockchain address of the customer.
...
//-- Sample Post 
$_POST['address']="3901 North Mattis Avenue Champaign, Illinois 61822";
$_POST['gtin']="00001300872071";
$_POST['lot']="AM09982A";
$_POST['customer_name']="Specely sprockets";		//-- Added to 'data'
$_POST['po_number']="11244000";						//-- Added to 'data'
$_POST['shipment_id']="1Z9999999999999888";			
$_POST['transport_company']="ACME Shipping";		//-- Added to 'shipment_data'

$url = 'https://traceabilityapi.net/ship';   //-- Microsoft Azure
